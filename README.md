...
- 📤 **材料上传**：支持 PDF / Word / Excel / 图片 / 文本等所有常见格式，浏览器本地解析（数据不上传服务器）
...
| 格式 | 扩展名 | 解析方式 | 状态 |
|------|--------|---------|------|
| 文本 | .txt .csv .md .json .log | 直接读取 | ✅ 完全支持 |
| PDF | .pdf | pdf.js 提取文本 | ✅ 完全支持 |
| Word | .docx | mammoth.js 提取文本 | ✅ 完全支持 |
| Word（旧版） | .doc | — | ⚠️ 仅记录，需另存为 .docx |
| Excel | .xls .xlsx .xlsm | SheetJS 提取表格 | ✅ 完全支持 |
| 图片 | .jpg .png .gif .bmp .webp | — | ⚠️ 仅记录文件信息 |
